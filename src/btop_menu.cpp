	...
	const vector<vector<vector<string>>> categories = {
		{
			...
			{"enable_websocket",
				"Enable WebSocket server for Resonite integration.",
				"",
				"Allows remote viewing of btop interface",
				"through WebSocket connection.",
				"",
				"Useful for displaying btop in VR applications",
				"like Resonite.",
				"",
				"Server will listen on the configured port.",
				"True or False."},
			{"websocket_port",
				...
				"Default is 8080.",
				"",
				"Only used if WebSocket server is enabled.",
				"",
				"Min value: 1024",
				"Max value: 65535"}
		},
